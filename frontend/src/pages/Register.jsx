          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-5">
              ...
              <div>
                <label htmlFor="phone" className="block text-sm font-semibold text-[#333333] mb-2">
                  Phone Number <span className="text-[#999999] font-normal">(Optional)</span>
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <svg className="h-5 w-5 text-[#999999]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center">
              <p className="text-sm text-[#666666]">
                ...
                <Link to="/login" className="font-semibold text-[#FF5A5F] hover:text-[#FF9A3D] transition-colors">
                  Sign in here
                </Link>
              </p>
            </div>
